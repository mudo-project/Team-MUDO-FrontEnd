...
export default function TwoButtonModal({ title, content, closeModal, activeModal, isPending = false }: { title: string, content: string, closeModal: () => void, activeModal: () => void, isPending?: boolean }) {
    return (
