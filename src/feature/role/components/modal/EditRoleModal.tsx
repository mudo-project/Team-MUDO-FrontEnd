            ...
            >
                        ...
                        <div className="flex-wrap flex w-[80%] gap-2 pt-2.5">
                            {roleColors.map((color, index) => (
                                <label
                                    ...
                                    className="flex w-7 size-7 cursor-pointer items-center justify-center rounded-full"
                ...
                <footer className="shrink-0 px-6 pb-6 pt-2 mt-2">
                    <div className="flex w-full justify-end gap-2">
                        <button
                            className="h-11 w-full rounded-[8px] border border-[#D7E8DB] bg-white px-5 text-[14px] leading-[21px] font-normal text-[#0F172A]"
                            onClick={closeModal}
                            type="button"
                        >
                            취소
                        ...
                        <button
                            className="h-11 w-full rounded-[8px] bg-[#0F172A] px-5 text-[14px] leading-[21px] font-semibold text-white disabled:cursor-not-allowed disabled:opacity-60"
                            disabled={isPending}
                            type="submit"
                        >
                            {isPending ? "수정 중..." : "수정"}
