...
export default function MemberStateFilter({ state }: { state: string }) {
    ...
    const activeClass = `leading-9 h-[34px] rounded-[6px] px-2.5 md:px-3.5 bg-white font-semibold shadow-[0_1px_1.5px_rgba(22,34,54,0.08)]`
    const noneActiveClass = `leading-9 h-[34px] rounded-[6px] px-2.5 md:px-3.5 text-[#64748B]`
