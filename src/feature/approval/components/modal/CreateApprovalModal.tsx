                ...
                <div className="flex w-full flex-col gap-3.5 pt-5">
                    <div className="w-full">
                        <label
                            ...
                            htmlFor="approval-template"
                        >
                            양식 선택
                        </label>
                        <div className="relative flex h-[35px] w-full items-center rounded-[8px] border border-[#D7E8DB] bg-white">
                            <select
                                className="h-full w-full appearance-none bg-transparent px-4 pr-9 text-[13px] font-normal text-[#0F172A] focus:outline-none"
                                defaultValue="leave"
                                id="approval-template"
                                name="template"
                            >
                                <option value="leave">연가 신청서</option>
                                <option value="expense">지출결의서</option>
                                <option value="overtime">초과근무 신청</option>
                                <option value="report">업무보고서</option>
                            </select>
                            <ChevronDown
                                className="pointer-events-none absolute right-2.5 size-3.5 text-[#0F172A]"
                                strokeWidth={2}
                            />
                        </div>
                    </div>
                    ...
                    <button
                        className="h-10 w-full rounded-[8px] bg-[#0F172A] text-[13px] font-semibold leading-[19.5px] text-white opacity-40"
                        type="submit"
                    >
                        상신하기
                    </button>
