    ...
    return (
        <div
            ...
            <div
                ...
                className="fixed top-1/2 left-1/2 z-1000 max-h-[85vh] h-[48vh] w-[680px] -translate-x-1/2 -translate-y-1/2 rounded-[14px] bg-white p-5 shadow-[0_8px_20px_rgba(22,34,54,0.18)]">
