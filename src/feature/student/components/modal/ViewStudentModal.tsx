...
export default function ViewStudentModal({ closeModal }: { closeModal: () => void }) {
            ...
            <section className="relative z-1000 w-[500px] overflow-hidden rounded-[14px] bg-white shadow-[0_8px_40px_rgba(0,0,0,0.18)]" onClick={(event) => event.stopPropagation()}>
                ...
                <section className="border-b border-[#F0F3F1] px-6 py-5">
                    ...
                    <div className="mt-3 grid grid-cols-2 gap-x-5 gap-y-2.5">
                        <div>
                            ...
                            <p className="mt-[3px] text-[13px] leading-[19.5px] font-medium text-[#1D2B3A]">010-2345-6789</p>
                        </div>
                        <div>
                            <p className="text-[11px] leading-[16.5px] text-[#94A3B8]">학부모 연락처</p>
                            <p className="mt-[3px] text-[13px] leading-[19.5px] font-medium text-[#1D2B3A]">010-8765-4321</p>
                        </div>
                        <div>
                            <p className="text-[11px] leading-[16.5px] text-[#94A3B8]">학교</p>
                            <p className="mt-[3px] text-[13px] leading-[19.5px] font-medium text-[#1D2B3A]">한빛고등학교</p>
                        </div>
                        <div>
                            <p className="text-[11px] leading-[16.5px] text-[#94A3B8]">학년</p>
                            <p className="mt-[3px] text-[13px] leading-[19.5px] font-medium text-[#1D2B3A]">고1</p>
                        </div>
                        <div>
                            <p className="text-[11px] leading-[16.5px] text-[#94A3B8]">특이사항</p>
                            <p className="mt-[3px] text-[13px] leading-[19.5px] font-medium text-[#1D2B3A]">—</p>
                        </div>
                    </div>
                </section>
                ...
                <section className="px-6 pt-5 pb-6">
                    ...
                    <div className="mt-3 flex items-center justify-between rounded-[10px] border border-[#E8F0EB] bg-[#F7FAF8] px-3.5 py-3">
                        <div>
                            <p className="text-[13px] leading-[19.5px] font-semibold text-[#1D2B3A]">영어B반</p>
                            <p className="pt-0.5 text-[11px] leading-[16.5px] text-[#64748B]">박서연 · 2026.01.10</p>
                        </div>
                        <div className="flex items-center gap-1.5">
                            <span className="rounded-full bg-[#D1EAE4] px-2 py-[3px] text-[10px] leading-[15px] font-semibold text-[#3D7A6A]">
                                수강중
                            </span>
                            <button className="rounded-[6px] border border-[#DCE8E2] bg-white px-2 py-1 text-[11px] leading-[16.5px] text-[#64748B]" onClick={endLectureModal.openModal} type="button">
                                수강 종료
                            </button>
                        </div>
                    </div>
