...
export default function WorkItem({ setSelectedTask, task, type }: { setSelectedTask: Dispatch<SetStateAction<number | undefined>>, task: WorkspaceTaskData, type: 'WAITING' | 'IN_PROGRESS' | 'COMPLETED' }) {
    return (
        <>
            <button
