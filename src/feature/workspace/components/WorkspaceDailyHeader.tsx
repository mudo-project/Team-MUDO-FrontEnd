...
export default function WorkspaceDailyHeader({ workspaceId, taskCount }: { workspaceId: string, taskCount: number | undefined }) {
    ...
    return (
        <header className="border-b border-[#E9ECF1] px-2 pt-3 pb-3 sm:px-3 md:px-4 lg:px-6 lg:pt-3.5 lg:pb-[15px]">
            ...
            <p className="h-[18px] pl-0.5 pt-0.5 text-[10px] leading-[16px] text-[#B5BDC8] sm:text-[11px] lg:h-5 lg:text-[12px] lg:leading-[18px]">업무 {taskCount}건</p>
        </header>
    )
}
